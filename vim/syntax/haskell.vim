...
"
" Prem: raichoo's syntax ends up defining function names as identifiers, and 
" since raichoo links identifier to Identifier (in colorscheme), function names 
" get highlighted with the color defined for Identifier in your colorscheme.
"
" this works fine for solarized and apprentice, but with sorcerer, you end up 
" having no color at all for function name in the type signature. to fix this 
" problem, i made the following changes:
...
syn match haskellFunction "[_a-z][a-zA-z0-9_']*" contained
